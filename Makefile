...
SOURCES = \
	__init__.py \
	tiff_generator.py tiff_generator_dockwidget.py

PLUGINNAME = tiff_generator

PY_FILES = \
	__init__.py \
	tiff_generator.py tiff_generator_dockwidget.py

UI_FILES = tiff_generator_dockwidget_base.ui
...
QGISDIR=C:\Users\diego\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
